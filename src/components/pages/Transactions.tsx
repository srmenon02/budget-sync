...
function TransactionRow({ tx }: { tx: Transaction }) {
  ...
  return (
    <div className="flex items-center justify-between py-3.5 border-b border-ink-border/60 last:border-0">
  ...
  return (
    <div className="flex flex-col gap-8">
      <div className="flex items-end justify-between animate-fade-up">
        <div>
          <p className="font-mono text-xs text-parchment-dim uppercase tracking-widest mb-1">All</p>
          <h1
      ...
      {isLoading ? (
        ...
        <>
          <div className="animate-fade-up delay-1 grid grid-cols-3 gap-3">
            <div className="font-mono rounded-lg border border-ink-border bg-ink-card/50 px-4 py-3 text-center">
              <p className="text-xs text-parchment-dim mb-1">Entries</p>
              <p className="text-parchment text-lg">{data!.length}</p>
            </div>
            <div className="font-mono rounded-lg border border-jade/20 bg-jade/5 px-4 py-3 text-center">
              <p className="text-xs text-parchment-dim mb-1">In</p>
              <p className="text-jade text-lg">{fmt(totalIn)}</p>
            </div>
            <div className="font-mono rounded-lg border border-coral/20 bg-coral/5 px-4 py-3 text-center">
